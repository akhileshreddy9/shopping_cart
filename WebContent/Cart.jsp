<%@page import="com.shopping.dao.ShoppingCartDAO"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.*" %>    
<%@ page import="com.shopping.model.CartTableBean" %>
...
<%
  ShoppingCartDAO obj=new ShoppingCartDAO();
	
	List<CartTableBean> result = new ArrayList<CartTableBean>();
	
	result = obj.getProducts(uid);
