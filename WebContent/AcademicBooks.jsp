...
<br><br><br><br>
	...
	<form action="Book11.jsp"  >
		<table  >
			<tr>
				<td> <img src="img/b11.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="book11"><button  class="but1" type="button">Corporate Financial Management  Rs:1500/- </button></td>
	...
	<form action="Book12.jsp">
		<table >
			<tr>
				<td> <img src="img/b12.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="book12" ><button  class="but2" type="button">The Brain Rs:800/- </button></td>
						
		   </tr>
	   </table>
      </form>

	<form action="Book13.jsp">
		<table >
			<tr>
				<td> <img src="img/b13.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
			    <td> <input type="submit" value="ShopNow" name="book13"><button  class="but3" type="button">Financial Management  Rs:1,000 </button></td>
		   </tr>
	   </table>
      </form>
      
      <form action="Book14.jsp">
		<table >
			<tr>
				<td> <img src="img/b14.jpg" width="700px" height="300px" style="margin: 50px; margin-left:230px;"></td>
				<td> <input type="submit" value="ShopNow" name="book14"><button  class="but4" type="button">Economic Development and GIS  Rs:1,700 </button></td>
