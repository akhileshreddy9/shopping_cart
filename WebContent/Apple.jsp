...
<br><br><br><br>
		...
		<img class="iphone" src="img/iphone6.jpg" width="300px" height="300px" >
		<p class="name"> Apple Iphone 6</p>
      ...
      <form action="Cart" method="get">
		<table >
			<tr>
				<td><input type="hidden" name="productId" value="1"></td>
				<td> <input class="sub"  type="submit" value="AddToCart" name="apple"></td>
