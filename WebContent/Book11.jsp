...
<br><br><br><br>
		...
		<img class="b11" src="img/b11.jpg" width="200px" height="300px" >
		<p class="name"> Corporate Financial Management</p>
		<p class="price">Price Rs:1,500</p>
      ...
      <form action="CartServlet" method="get">
		<table >
			<tr>
				<td><input type="hidden" name="productId" value="5"></td>
	...
	<tr>
	<td>Book</td>
	<td>Corporate Financial Management</td>
	</tr>
