...
<br><br><br><br>
		...
		<img class="alien" src="img/alienware.jpg" width="400px" height="300px" >
		<p class="name"> ALIENWARE</p>
		<p class="price">Price Rs:1,65,000</p>
      ...
      <form action="Cart" method="get">
		<table >
			<tr>
				<td><input type="hidden" name="productId" value="3"></td>
				<td> <input class="sub"  type="submit" value="AddToCart" name="alieanware"></td>
